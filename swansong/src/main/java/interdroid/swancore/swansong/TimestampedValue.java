...
public class TimestampedValue implements Serializable, Parcelable,
     ...
     *
     * @param values an array of timestamped values (double or castable to double)
     ...
     * Find maximum value.
     *
     * @param values an array of timestamped values
     * @return the timestamped maximum value
     */
    @SuppressWarnings({"unchecked", "rawtypes"})
    public static TimestampedValue findMaxValue(
            final List<TimestampedValue> values) {
        Log.d("collection rahul","rahul");
        Collections.max(values);
        Log.d("collection end rahul","rahul");
     ...
     * The CREATOR.
     */
    public static final Creator<TimestampedValue> CREATOR = new Creator<TimestampedValue>() {
        ...
        if (o instanceof TimestampedValue) {
            ...
            if (mValue instanceof Comparable<?>
                ...
                if (((Comparable) mValue)
                        .compareTo(((TimestampedValue) o).mValue) == 0) {
                    return true;
                }
            }
        }
