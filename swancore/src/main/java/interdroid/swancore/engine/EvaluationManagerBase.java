...
public class EvaluationManagerBase {
    ...
    public EvaluationManagerBase(Context context) {
        mContext = context;
    }
...
//        }
     ...
     * Override this method in SWAN Phone app
     * @param expression
     * @param toRegistrationId
     * @return
     */
    protected String toCrossDeviceString(Expression expression,
                                       String toRegistrationId) {
        throw new RuntimeException("toCrossDeviceString is not implemented, you should not call this");
    }

    /**
     * Proximity Manager related, override this in SWan Phone app
     * @param id
     * @param expression
     */
                            ...
                            public void onServiceConnected(ComponentName name,
                                ...
                                try {
                                    sensor.register(id,
                                            ...
                                            expression.getExtraConfiguration());
    ...
    protected DeferUntilResult remainsValidUntil(ValueExpression expression,
        ...
        if (expression instanceof MathValueExpression) {
            ...
            HistoryReductionMode mode = expression
    ...
    protected boolean shortcut(LogicExpression expression, Result first) {
        ...
        return (first.getTriState() == TriState.FALSE && expression.getOperator()
